					...
					<div class="card-body">
						...
						<form:form class="form-signin" modelAttribute="form">
							<div class="form-label-group my-1">
								...
								<form:input path="userEmail" type="email" class="form-control" value="${user.userEmail}" />
							</div>
							<div class="form-label-group my-1">
								<form:label path="userPass" for="inputPassword">Password</form:label>
								<form:input path="userPass" type="password" class="form-control" value="${user.userPass}" />
							</div>
							<hr class="my-4">
							<div class="form-label-group my-1">
							...
							<div class="form-label-group my-1">
								...
								<form:input path="userPhone" type="text" class="form-control" value="${user.userPhone}" />
							</div>
							<div class="form-label-group my-1">
								<form:label path="userStreet1">Street Address</form:label>
								<form:input path="userStreet1" type="text" class="form-control" value="${user.userStreet1}" />
							</div>
							<div class="form-label-group my-1">
								<form:label path="userStreet2">Address Line 2 (Apt #, Unit #, etc)</form:label>
								<form:input path="userStreet2" type="text" class="form-control" value="${user.userStreet2}" />
							</div>
							<div class="form-label-group my-1">
								<form:label path="userCity">City</form:label>
								<form:input path="userCity" type="text" class="form-control" value="${user.userCity}" />
							</div>
							<div class="form-label-group my-1">
								<form:label path="userState">State</form:label>
								<form:input path="userState" type="text" class="form-control" value="${user.userState}" />
							</div>
							<div class="form-label-group my-1">
								<form:label path="userCountry">Country</form:label>
								<form:input path="userCountry" type="text" class="form-control" value="${user.userCountry}" />
							</div>
